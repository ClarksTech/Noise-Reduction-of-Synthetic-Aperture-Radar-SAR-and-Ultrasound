function [filtered_image_matrix_with_pad, generated_filter_window] = image_gaussian_filter(Row, Col, new_image, pixels_in_window, window_size, std_dev, generated_filter_window)
%==========================================================================
...
% return filter window for next position of window
